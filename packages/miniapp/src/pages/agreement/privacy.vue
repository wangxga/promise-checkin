...
<template>
  <view class="page">
    <view class="content">
      ...
      <text class="updated">最后更新：2026年7月</text>

      <text class="h2">一、信息收集</text>
      <text class="p">
        「如约打卡」是一个本地的计划打卡工具。我们仅收集以下信息用于提供核心功能：
      </text>
      <text class="p">1. 微信登录凭证（openid）：用于识别用户身份，不包含敏感个人信息。</text>
      <text class="p">2. 昵称和头像：仅在您主动授权后获取，用于展示。</text>
      <text class="p">
        3. 您主动创建的打卡数据（计划名称、打卡记录、备注等）：这些数据完全由您控制，存储在服务器上仅供您本人查看。
      </text>

      <text class="h2">二、信息使用</text>
      <text class="p">您的信息仅用于：</text>
      <text class="p">· 提供打卡、进度统计、日历查看等核心功能</text>
      <text class="p">· 在您主动操作时展示给您本人</text>
      ...
      <text class="p">· 您可以退出登录清除本地缓存数据。</text>
